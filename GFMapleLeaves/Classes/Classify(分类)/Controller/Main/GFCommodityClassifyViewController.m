//
//  GFCommodityClassifyViewController.m
//  GFMapleLeaves
//
...
@interface GFCommodityClassifyViewController ()<UITableViewDelegate,UITableViewDataSource,UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
@implementation GFCommodityClassifyViewController
...
//    _topSearchView.frame = CGRectMake(50, 6, ScreenW - 110, 32);
    _topSearchView.frame = CGRectMake(8, 6, ScreenW - 30, 32);
    ...
    _qrCodeButton.adjustsImageWhenHighlighted = NO;
    _qrCodeButton.frame = CGRectMake(_topSearchView.dc_width - 40, 0, 35, _topSearchView.dc_height);
    [_qrCodeButton addTarget:self action:@selector(voiceButtonClick) forControlEvents:UIControlEventTouchUpInside];
    [_qrCodeButton setImage:[UIImage imageNamed:@"group_home_scan_gray"] forState:0];
    [_topSearchView addSubview:_qrCodeButton];
    }

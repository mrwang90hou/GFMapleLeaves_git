...
//  GFMapleLeaves
//
//  Created by mrwang90hou on 2018/9/27.
...
//        make.left.mas_equalTo(self.pciImageView);
//        make.bottom.mas_equalTo(self.pciImageView);
//        make.size.mas_equalTo(CGSizeMake(30, 18));
//    }];
    
//    [_nickName mas_makeConstraints:^(MASConstraintMaker *make) {
//        [make.top.mas_equalTo(self.pciImageView.mas_bottom)setOffset:2];
//        make.left.mas_equalTo(self.pciImageView);
//    }];
}

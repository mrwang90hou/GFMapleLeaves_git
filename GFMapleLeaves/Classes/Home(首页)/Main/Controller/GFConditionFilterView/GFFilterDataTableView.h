...
@protocol GFFilterDataTableViewDelegate <NSObject>
...
@interface GFFilterDataTableView : UITableView

@property (nonatomic,weak) id<GFFilterDataTableViewDelegate> sortDelegate;
/** 选中的数据*/

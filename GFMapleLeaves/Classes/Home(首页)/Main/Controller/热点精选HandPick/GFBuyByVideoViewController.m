...
@interface GFBuyByVideoViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
/* scrollerVew */
...
@implementation GFBuyByVideoViewController
...
-(void)requestData{
    ...
    [GCHttpDataTool getVideoListWithDict:dict success:^(id responseObject) {

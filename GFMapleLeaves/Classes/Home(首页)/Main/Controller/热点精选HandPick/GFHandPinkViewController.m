//
//  GFHandPinkViewController.m
//  GFMapleLeaves
//
//  Created by mrwang90hou on 2018/11/4.
...
@interface GFHandPinkViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
{
...
- (UICollectionView *)collectionView
{
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[GFConditionFilterView class] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:GFConditionFilterViewID]; //头部View
...
- (void)viewDidLoad {
    ...
    self.title = [arrStr objectAtIndex:self.typeNumber];
    [self setUpNav];
...
-(void)requestData:(NSInteger)type{
    ...
    [GCHttpDataTool getHandPinkWithDict:dict typeNumber:type success:^(id responseObject) {

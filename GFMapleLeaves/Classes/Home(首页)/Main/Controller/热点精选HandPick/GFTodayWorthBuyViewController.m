//
//  GFTodayWorthBuyViewController.m
//  GFMapleLeaves
//
...
@interface GFTodayWorthBuyViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
/* scrollerVew */
...
@implementation GFTodayWorthBuyViewController
...
-(void)requestData{
    ...
    [GCHttpDataTool getTodayBuyWithDict:dict success:^(id responseObject) {

...
- (void)setUpUI
{
    ...
    _leftItemButton = ({
        ...
        [button setImage:[UIImage imageNamed:@"home_icon_menu"] forState:UIControlStateNormal];
    ...
    _rightItemButton = ({
        UIButton * button = [UIButton new];
        [button setImage:[UIImage imageNamed:@"home_icon_message"] forState:UIControlStateNormal];
...
{
    !_qrCodeButtonClickBlock ? : _qrCodeButtonClickBlock();
}

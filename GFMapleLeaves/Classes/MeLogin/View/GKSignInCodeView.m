...
//    });
    ...
    WEAKSELF
    if (![self.phoneTF.text isEqualToString:@""] && ![self.pwdTF.text isEqualToString:@""]) {
        
        [DCObjManager dc_saveUserData:@"1" forKey:@"isLogin"]; //1代表登录
        [DCObjManager dc_saveUserData:self.phoneTF.text forKey:@"UserName"]; //记录用户名

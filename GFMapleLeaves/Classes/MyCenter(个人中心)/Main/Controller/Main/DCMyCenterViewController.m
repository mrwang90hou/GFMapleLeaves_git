...
//        [weakSelf.navigationController.navigationBar setBarTintColor:[UIColor colorWithRed:41/255.0 green:134/255.0 blue:227/255.0 alpha:1]];
        [weakSelf.navigationController.navigationBar setBarTintColor:GFPink2Cokor];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    _topToolView.backgroundColor = (scrollView.contentOffset.y > 64) ? GFPink2Cokor : [UIColor clearColor];

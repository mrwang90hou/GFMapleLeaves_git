...
- (void)layoutSubviews
{
    ...
    [_topSearchView mas_makeConstraints:^(MASConstraintMaker *make) {
        [make.left.mas_equalTo(weakSelf.leftItemButton.mas_right)setOffset:15];
        [make.right.mas_equalTo(weakSelf.rightItemButton.mas_left)setOffset:-15];
        make.height.mas_equalTo(@(32));
        make.centerY.mas_equalTo(weakSelf.rightItemButton);
